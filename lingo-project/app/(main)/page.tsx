    ...
    <>
      <Container>
        ...
        <div className="text-black text-[20px] sm:text-[48px] sm:leading-11 [font-family:var(--font-montserrat)] font-bold ">
            ...
            <Link
              href="/events"
              className="bg-[#3A5F9D] text-primary-foreground hover:bg-[#3a5e9dec] inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap text-md transition-all disabled:pointer-events-none disabled:opacity-65 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive w-[100px] sm:w-[180px] sm:h-[50px] text-[15px] sm:text-[18px]"
            >
              Найти
            </Link>
